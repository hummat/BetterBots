...
3. **M3 (closed v0.4.0):** Ability quality + bot fixes — ~~suppression (#11)~~, ~~charge rescue (#10)~~. ~~Fix Psyker overcharge (#27).~~ ~~Don't interrupt revive (#20).~~ ~~Poxburster targeting (#34).~~ ~~ADS fix (#35).~~ ~~Bot sprinting (#36).~~
