...
3. Item-based combat fallback.
   - Status: implemented (experimental sequence matching on `weapon_action`).
   - Next: convert heuristic matching to explicit per-template map.
...
[x] P0.3 Initial item fallback (experimental)
