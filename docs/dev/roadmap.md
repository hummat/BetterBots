...
|---|---|---|---|
| R1 | `#108` Human revive priority | Closed | Closed from `console-2026-04-29-17.10.48...`: repeated bot 2 `human revive priority assigned` markers on the same human target, ally-rescue sprint, `shield (revive)`, and follow-up `interacting with` blocks confirm the BetterBots assignment and vanilla interaction seam. |
