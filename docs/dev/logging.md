...
- `melee special prelude queued before <attack>` (`#33` narrow Sprint 3 powered-melee identity; BetterBots prepended `special_action` before the chosen melee attack against an elite/specialist target)
