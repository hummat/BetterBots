...
describe("settings", function()
	...
	describe("is_feature_enabled", function()
		it("returns true for all known features when settings return nil", function()
			...
			assert.is_true(Settings.is_feature_enabled("human_revive_priority"))
		...
		it("gates human_revive_priority feature correctly", function()
			Settings.init(mock_mod({ enable_human_revive_priority = false }))
			assert.is_false(Settings.is_feature_enabled("human_revive_priority"))
		end)
